...
scale_normal = 0.3 # std of the normal random variable used for the additional noise
...
results = [np.empty((n_RMSE, n_alphas, BiDifferenceExponential().dim), dtype=np.float64) for i in range(2)]
